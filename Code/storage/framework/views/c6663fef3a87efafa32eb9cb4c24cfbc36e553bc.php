...
document.addEventListener('DOMContentLoaded', function() {
    ...
    addModuleBtn.addEventListener('click', function() {
        ...
        // Prevent duplicate
        if (addedModules.some(m => m.moduleId === moduleId && m.semester === semester)) return;
...
semesterForm.addEventListener('submit', function(e) {
    ...
    const requiredFields = ['location', 'course_id', 'intake_id', 'semester', 'start_date', 'end_date', 'registration_date', 'status'];
    const missingFields = [];
...
<?php echo $__env->make('inc.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\thisali\Desktop\Github\Nebula-Project\Code\resources\views/semester_creation.blade.php ENDPATH**/ ?>