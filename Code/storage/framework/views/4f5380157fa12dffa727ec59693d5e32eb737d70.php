            ...
            if (nic) {
                ...
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        showToast('An error occurred while fetching student details.', 'danger');
                        $('#studentDetailsSection').hide();
                    },
                    complete: function() {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('inc.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\thisali\Desktop\Github\Nebula-Project\Code\resources\views/course_registration.blade.php ENDPATH**/ ?>