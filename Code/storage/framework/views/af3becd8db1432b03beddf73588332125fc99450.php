    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="text-center mt-4" id="updateAllBtnSection" style="display:none;">
                <button type="button" id="updateAllBtn" class="btn btn-primary w-100 py-2">Update All Results</button>
            </div>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateStatistics(results) {
        ...
        const passedStudents = results.filter(result => ['A', 'B', 'C', 'D'].includes(result.grade)).length;
...
<?php echo $__env->make('inc.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\thisali\Desktop\Github\Nebula-Project\Code\resources\views/exam_results_view_edit.blade.php ENDPATH**/ ?>